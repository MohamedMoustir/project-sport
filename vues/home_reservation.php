      ...
      <form class="flex flex-col items-stretch pt-3 pb-8 md:pt-8">
        <div class="grid gap-x-4 gap-y-3 sm:grid-cols-2">
          <label class="block" for="name">
            ...
            <input class="w-full rounded-md border bg-white py-2 px-2 outline-none ring-yellow-500 focus:ring-2" type="text" placeholder="Entrez votre nom complet" />
          </label>
          <label class="block" for="email">
            <p class="mb-1 mt-2 text-sm text-gray-600">Adresse e-mail</p>
            <input class="w-full rounded-md border bg-white py-2 px-2 outline-none ring-yellow-500 focus:ring-2" type="email" placeholder="Entrez votre e-mail" />
          </label>
          <label class="block" for="phone">
            <p class="mb-1 mt-2 text-sm text-gray-600">Numéro de téléphone</p>
            <input class="w-full rounded-md border bg-white py-2 px-2 outline-none ring-yellow-500 focus:ring-2" type="text" placeholder="Entrez votre numéro de téléphone" />
          </label>
          <label class="block" for="consultation-type">
            <p class="mb-1 mt-2 text-sm text-gray-600">Type de specialite</p>
            <select class="w-full rounded-md border bg-white py-2 px-2 outline-none ring-yellow-500 focus:ring-2">
          ...
          <label class="block sm:col-span-2" for="message">
            ...
            <textarea class="h-32 w-full rounded-md border bg-white py-2 px-2 outline-none ring-yellow-500 focus:ring-2" placeholder="Décrivez votre problème ou demande"></textarea>
          </label>
        </div>
        <div class="block">
        ...
        <button type="submit" class="mt-6 rounded-full bg-yellow-400 px-4 py-2 text-center text-base font-semibold font- shadow-md outline-none ring-yellow-500 ring-offset-2 transition hover:bg-yellow-400 focus:ring-2 md:w-40">Envoyer</button>
      </form>
    </div>
  </div>
</div>
