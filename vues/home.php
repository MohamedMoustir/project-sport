...
<header class='flex shadow-md py-3 px-4 sm:px-10 bg-[#282E3F] text-white  min-h-[70px] tracking-wide relative z-50'>
...
<section>
  ...
  <div class="flex flex-col lg:flex-row items-center justify-between mx-auto px-5 lg:px-[100px] h-auto lg:h-[800px]">
    <div class="w-full mb-10 lg:mb-0">
      ...
      <div class="border w-full lg:w-[150%] flex items-center  lg:bg-white rounded-full mt-5  px-[10px] h-[70px] relative z-10 grid grid-cols-1 lg:grid-cols-3 ">
